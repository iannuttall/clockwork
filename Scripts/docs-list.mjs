#!/usr/bin/env node
// Walk docs/, parse `summary` / `read_when` YAML front matter, print an index,
// and flag files missing front matter. Pure Node (no deps).
...
if (!existsSync(DOCS_DIR)) {
    console.log('No docs/ directory found. Create docs/ with Markdown files that carry');
    console.log('`summary:` and optional `read_when:` YAML front matter.');
    process.exit(0);
}
