...
final class SchedulerPanel: NSPanel {
...
final class PanelController: NSObject, NSWindowDelegate {
    ...
    private var panel: SchedulerPanel?
    ...
    private func makePanel() -> SchedulerPanel {
        let panel = SchedulerPanel(
    ...
    private func showContextMenu() {
        ...
        menu.addItem(withTitle: "Quit Scheduler", action: #selector(self.quit), keyEquivalent: "q")
